...
axs[1, 0].set_title('Subject 3')

axs[1, 1].scatter(x, y4)
axs[1, 1].set_title('Subject 4')

axs[2, 0].scatter(x, average)
axs[2, 0].set_title('average')

fig.delaxes(axs[2, 1])

for l in [15, 30, 70, 110, 125]:
    for ax in axs.flat:
        ax.axvline(x=l, linestyle='--', c='orange')

fig.text(0.64, 0.26, 'Y Axis =Horizontal Displacement (cm)', ha='center')
fig.text(0.608, 0.28, 'X Axis = Amount of throws', ha='center')

plt.tight_layout()
plt.subplots_adjust(top=0.9)
plt.suptitle('Fish2Meta Experiment Graph')
